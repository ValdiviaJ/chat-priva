...
export const HomePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#080d1a] text-slate-900 dark:text-slate-100 flex flex-col justify-between transition-colors duration-200">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8 max-w-4xl w-full mx-auto">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-900 dark:text-white tracking-tight mb-3">
            ...
            <span className="text-blue-600 dark:text-blue-500">Solo dos personas.</span>
          </h1>
      ...
      <footer className="py-4 text-center text-xs text-slate-500 dark:text-slate-400 border-t border-slate-200 dark:border-[#1a2333]">
